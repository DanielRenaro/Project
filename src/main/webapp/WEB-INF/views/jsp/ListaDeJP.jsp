			...
			<div class="col-md-6">
				<div class="input-group h2">
					<input name="data[search]" class="form-control" id="search"
						type="text" placeholder="Pesquisar Jovens Profissionais" /> <span
				...
				<table class="table table-striped" cellspacing="0" cellpadding="0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="actions">
							<a href="editionJP">	<button type="button" class="btn btn-primary btn-xs">Editar</button></a>
							<a href="excluiJP">	<button type="button" class="btn btn-primary btn-xs">Excluir</button></a>
							</td>
						</tr>
